...
class PDF extends FPDF
{
    ...
    function ec(/*$reep,$qtee,$lge,$hte*/)
    {
        ...
        $this->SetXY(82,29);
        $this->Cell(40,10,'Garde Corps Barreude',0,1,'C');
...
$pdf->Image('2020-02-04 08_46_08-Microsoft Excel (Échec de l’activation du produit) - G C Droit Barreaudé 2020.xl.png',20,58,60,0);
