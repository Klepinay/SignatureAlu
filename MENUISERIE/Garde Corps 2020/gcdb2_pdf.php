...
class PDF extends FPDF
{
    ...
    function ec(/*$reep,$qtee,$lge,$hte*/)
    {
        ...
        $this->SetXY(82,29);
        $this->Cell(40,10,'Garde-Corps Vitre Droit JMD',0,1,'C');
...
$pdf->Image('2020-02-04 16_52_05-Microsoft Excel (Échec de l’activation du produit) - G C Droit Vitré JMD 2020.xl.png',20,58,60,0);
