...
class PDF extends FPDF
{
    ...
    function ec(/*$reep,$qtee,$lge,$hte*/)
    {
        ...
        $this->SetXY(82,29);
        $this->Cell(40,10,'Garde-Corps Rampant Vitre JMD',0,1,'C');
...
$pdf->Image('2020-02-05 10_01_43-Microsoft Excel (Échec de l’activation du produit) - G C Rampant Vitré JMD 2020..png',20,58,50,0);
