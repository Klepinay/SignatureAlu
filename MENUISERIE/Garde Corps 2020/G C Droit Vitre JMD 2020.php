...
<html>
	<head>
		<title>G C Droit Vitré 2020</title>
	...
	<body>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan=4 align="center">
						<h1>Garde-Corps Vitré Droit JMD</h1>
					</td>
				</tr>
				<tr >
					<td>
				...
				<tbody>
					...
					<table align="center" width="100%" border="0" style="border-collapse: collapse">
						...
						<tr align="center">
							<td>
								<img  src="\Signature\images\2020-02-04 16_52_05-Microsoft Excel (Échec de l’activation du produit) - G C Droit Vitré JMD 2020.xl.png">
							</td>
							<td>
							</td>
							<td></td>
						...
						<tr align="center">
							<td>
								<label><b>Hauteur</b> Fini du G-C : </label><input type="number">&nbsp;
								<p>(Pose sur muret) </p>
							</td>
							<td>
							</td>
						...
						<tr align="center">
							<td colspan=3>
								<label>Vitrage : <input type="number" style="">&nbsp;</label>
							</td>
						</tr>
						<tr height="25px"></tr>
						<tr align="center">
		...
		<table border="0" width="100%" style="border-collapse: collapse; margin-top:400px;">
			<tr align="center" style="border-top: 2px #000000 solid;">
				<td style="border-top: 2px #000000 solid;">
					<p><label>Hauteur Point de Niveau / Linteau :</label><input type="number" style="width:25px">&nbsp; </p>
				</td style="border-top: 2px #000000 solid;">
				<td></td>
				<td colspan=3 style="border-top: 2px #000000 solid;">						
					<p><label>Hauteur Point de Niveau / Sol Fini :</label><input type="number" style="width:25px">&nbsp; </p>
				</td>
			</tr>
			<tr>
				<td align="right" >
	...
	<div class="noImpr">
		<p align="center"><a href="gcdb2_pdf.php">save</a></button></p>	
