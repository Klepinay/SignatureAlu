...
class PDF extends FPDF
{
    ...
    function ec(/*$reep,$qtee,$lge,$hte*/)
    {
        ...
        $this->SetXY(82,29);
        $this->Cell(40,10,'Coulissant 2Vtx',0,1,'C');
    ...
    function cgauche()
    {
        ...
        $this->SetFont('Arial','B',11);
        $this->SetXY(45,158);
        $this->Cell(40,3.5,'Sens Ouverture (Vue int)',0,1,'C',true);
        ...
        //
        $this->SetXY(145,212);
        $this->Cell(10,5,'Fast Block + Lock',0,1,'L');
        $this->SetXY(140,212);
        $this->Cell(5,3.5,'',1,1,'C');
...
$pdf->cgauche();
$pdf->Image('C1.png',47,98,25,0);
$pdf->Image('C1-1.png',25,165,80,0);
$pdf->cdroite();

$pdf->bas();
//telechargement du pdf

$pdf->output('F','testttttt.pdf');