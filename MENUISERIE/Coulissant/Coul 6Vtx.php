<!DOCTYPE html>
	...
	<div class="noImpr">
		<p align="center"><a href="Coul6_pdf.php">save</a></button></p>	
		<p align="center"><button><a href="/Signature/nouvelle_prise_de_cote.php?technicien=<?php echo $_GET['technicien'] ?>&numero=<?php echo $_GET['numero'] ?>&date=<?php echo $_GET['date'] ?>&Nchantier=<?php echo $_GET['Nchantier'] ?>&client=<?php echo $_GET['client'] ?>&adresse=<?php echo $_GET['adresse'] ?>&tel=<?php echo $_GET['tel'] ?>&commercial=<?php echo $_GET['commercial'] ?>&Nbrsmenuiserie=<?php echo $_GET['Nbrsmenuiserie'] ?>&ral=<?php echo $_GET['ral'] ?>">Nouvelle Prise de Cote</a></button></p>
			...
			<script>
				...
				var l7 = document.getElementById("canvas2");
				var ctx = l7.getContext("2d");
				ctx.moveTo(0, 85);
				ctx.lineTo(40, 85);
				ctx.stroke();
				var l8 = document.getElementById("canvas2");
				var ctx = l8.getContext("2d");
				ctx.moveTo(35, 80);
				ctx.lineTo(75, 80);
				ctx.stroke();
				var l9 = document.getElementById("canvas2");
				var ctx = l9.getContext("2d");
				ctx.moveTo(70, 75);
				ctx.lineTo(110, 75);
				ctx.stroke();
				var l10 = document.getElementById("canvas2");
				var ctx = l10.getContext("2d");
				ctx.moveTo(113, 75);
				ctx.lineTo(153, 75);
				ctx.stroke();
				var l11 = document.getElementById("canvas2");
				var ctx = l11.getContext("2d");
				ctx.moveTo(148, 80);
				ctx.lineTo(188, 80);
				ctx.stroke();
				var l12 = document.getElementById("canvas2");
				var ctx = l12.getContext("2d");
				ctx.moveTo(183, 85);
				ctx.lineTo(223, 85);
				ctx.stroke();
			</script> 
