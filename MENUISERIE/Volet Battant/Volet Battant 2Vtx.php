...
<html>
	...
	<head>
		<title>Volet Battant 2 Vtx</title>
		<meta charset="utf-8" >
 ...
 <table width="100%" border="0">
			...
			<table width="100%" border="0" style="border-collapse: collapse">
					...
					<tr>
						<td colspan=2 align="right">
							<canvas id="canvas1" width="150" height="100" style="border: 1px #000000 solid"></canvas>
						</td>
						<td></td>
						<td colspan=3 style="border-left: 2px #000000 solid;">
					...
					<tr >
						...
						<td colspan=3  style="border-left: 2px #000000 solid;">
							<p align="center"><img src="C:\Prise de cote\images\2020-02-19 09_17_38-Microsoft Excel (Échec de l’activation du produit) - VB 2 Vtx.xlsx  [Mode protég.png" ></p>
							<p><input type="checkbox" style="width: 20px; height:20px; margin-left: 140px;" id="gauche"><label for="gauche">Ouvrant Gauche</label>&nbsp;&nbsp; <input id="droite"  type="checkbox" style="width: 20px; height:20px; margin-left: 240px"><label for="droite">Ouvrant Droite</label></p>
						</td>
					</tr>
					<tr height="25px"></tr>
	...
	<div class="noImpr">
		<p align="center"><a href="Vb2_pdf.php">save</a></button></p>	
