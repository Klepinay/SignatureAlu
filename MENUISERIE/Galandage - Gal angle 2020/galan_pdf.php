...
class PDF extends FPDF
{
    ...
    function ec(/*$reep,$qtee,$lge,$hte*/)
    {
        ...
        #3
        $this->SetXY(110,42);
        $this->Cell(40,10,'Interieur',0,1,'C');
        $this->SetXY(115,44);
        $this->Cell(5,3.5,'',1,1,'C');
        $this->SetXY(125,42);
        $this->Cell(40,10,'Ou',0,1,'C');
        #4
        $this->SetXY(150,42);
        $this->Cell(40,10,'Exterieur',0,1,'C');
        $this->SetXY(155,44);
        $this->Cell(5,3.5,'',1,1,'C');
    ...
    function cdroite()
    {
        ...
        $this->Cell(5,3.5,'',1,1,'C');
        $this->SetXY(158,138);
        $this->Cell(30,3.5,'+50 Haut/+50 Bas',0,1,'C');
        //ht beton
        $this->SetXY(120,148);
        $this->Cell(30,3.5,'',1,1,'C');
        $this->SetXY(120,143);
        ...
        $this->Cell(30,3.5,'',1,1,'C');
        $this->SetXY(155,143);
        $this->Cell(30,3.5,'Hauteur Total :',0,1,'C');
