		...
		<form>
			<table width="100%" border="0">
				...
				<tr >
					...
					<td colspan=2 align="center">
						<span style="margin-right:170px" ><input type="checkbox" id="vt" style="width:20px; height:20px"><label for="vt"> 4 Vtx</label></span>
							Ou
						<span style="margin-left:170px" ><input id="vtx" type="checkbox" style="width:20px; height:20px"> <label for="vtx"> 8 Vtx</label></span>
					</td>
				</tr>
			</table>
