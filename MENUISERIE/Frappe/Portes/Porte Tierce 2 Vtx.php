...
<html>
	<head>
		<title>Porte Tierce 2 Vtx</title>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan=4 align="center">
						<h1>Porte Ouvrante Tierce 2 Vtx</h1>
					</td>
				</tr>
				<tr >
					<td>
				...
				<tr>
					...
					<td width="50%" colspan=3 style="border-left: 2px #000000 solid;">
							...
							<p style="margin-left:244px"><input type="checkbox"  style="width: 20px; height:20px" id="baurreaudehauteur">&nbsp;<label for="baurreaudehauteur">Barreaudé sur toute la hauteur</label></p>
					</td>
				</tr>
					<tr>
						<td colspan=3 >
	...
	<div class="noImpr">
		<p align="center"><a href="Porte3_pdf.php">save</a></button></p>	
