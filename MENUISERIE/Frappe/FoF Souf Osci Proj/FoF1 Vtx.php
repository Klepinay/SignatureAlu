...
<html>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<tr>
						...
						<td colspan=3>
							<div style="text-align:center; font-size: 24px; margin-bottom: 20px; margin-top:20px"><span style="background:#D9D9D9;"><b><i> Française </b></i>(vu int)</span></div>
						</td>
					</tr>
					<tr align="center">
						<td colspan=3>
						...
						<td colspan=3>
							<p><img src="C:\Prise de cote\images\2020-01-29 09_58_38-Microsoft Excel (Échec de l’activation du produit) - FoF 1 Vt.xlsx  [Mode protég.png"></p>
							<p><input type="checkbox" style="width: 20px; height:20px;" id="PG">&nbsp;<label for="PG">Poignée Gauche</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" style="width: 20px; height:20px;" id="PD">&nbsp;<label for="PD">Poignée Droit</label></p>
						</td>
					</tr>
					<tr>
						<td colspan=3 >
	...
	<div class="noImpr">
		<p align="center"><a href="fof1_pdf.php">save</a></button></p>		
