...
<html>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<tr >
						...
						<td colspan=3>
							<p style="margin-left:244px"><input type="checkbox"  style="width: 20px; height:20px" id="Taquet">&nbsp;<label for="Taquet">Taquet</label></p>
							<p style="margin-left:244px"><input type="checkbox"  style="width: 20px; height:20px" id="Cremone">&nbsp;<label for="Cremone">Crémone 3 Pts</label></p>
							<p style="margin-left:244px"><input type="checkbox"  style="width: 20px; height:20px" id="MS">&nbsp;<label for="MS">Moteur Soufflet</label></p>
							<p style="margin-left:244px"><input type="checkbox"  style="width: 20px; height:20px" id="MM5">&nbsp;<label for="MM5">Moteur Mistral (manuel)5M</label></p>
							<p style="margin-left:244px"><input type="checkbox"  style="width: 20px; height:20px" id="MM10">&nbsp;<label for="MM10">Moteur Mistral (manuel)10M</label></p>
							<p style="margin-left:244px"><input type="checkbox"  style="width: 20px; height:20px" id="KD">&nbsp;<label for="KD">Kit Désenfumage</label></p>
						</td>
					</tr>
					<tr>
						<td colspan=3 >
	...
	<div class="noImpr">
		<p align="center"><a href="Soufflet_pdf.php">save</a></button></p>	
