...
<html>
		...
		<form>
			<table width="100%" border="0">
				...
				<table width="100%" border="0" style="border-collapse: collapse">
					...
					<tr>
						<td colspan=3 >
							<p style="margin-left:244px"><input type="checkbox"  style="width: 20px; height:20px" id="27">&nbsp;<label for="27">27 mm</label><input type="checkbox" style="
							width: 20px; height:20px; margin-left: 50px" id="Droit">&nbsp;<label for="Droit">Droit</label></p>
						</td>
						<td style="border-left: 2px #000000 solid;">
						</td>
						<td colspan=3>
				...
				<tr>
					...
					<td width="8%">
						...
						<canvas id="canvas2" width="150" height="100" style="border: 1px #000000 solid"></canvas>
						<p align="center"><input type="checkbox" style="width: 17px; height: 17px;"></p>
					</td>
					...
					<tr>
						...
						<td colspan=3>
							<div style="text-align:center; font-size: 24px; margin-bottom: 20px; margin-top:20px"><span style="background:#D9D9D9;"><b><i> Française </b></i>(vue int)</span></div>
						</td>
					</tr>
					<tr align="center">
						<td colspan=3>
						...
						<td colspan=3>
							<p><img src="C:\Prise de cote\images\2020-01-29 10_14_39-Microsoft Excel (Échec de l’activation du produit) - FoF 2 Vtx.xlsx  [Mode proté.png"></p>
					...
					<tr>
						<td colspan=3>
							...
							<p style="margin-left:244px"><input type="checkbox" style="width: 20px; height:20px;" id="Htstand">&nbsp;<label for="Htstand">Ht Standard (Fenêtre 350)</label>
	...
	<div class="noImpr">
		<p align="center"><a href="Fof_2_pdf.php">save</a></button></p>	
