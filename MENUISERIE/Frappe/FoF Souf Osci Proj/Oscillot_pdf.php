...
class PDF extends FPDF
{
    ...
    function ec(/*$reep,$qtee,$lge,$hte*/)
    {
        ...
        $this->SetXY(82,29);
        $this->Cell(40,10,'Oscillot',0,1,'C');
    ...
    function cgauche()
    {
        ...
        //ht stand
        $this->SetXY(45,177);
        $this->Cell(5,3.5,'',1,1,'C',true);
        $this->SetXY(50,176);
        $this->Cell(10,5,'Ht Standard (Fenetre 350)',0,1,'L');
        //autre
        $this->SetXY(45,181);
        $this->Cell(5,3.5,'',1,1,'C',true);
        $this->SetXY(50,180);
        $this->Cell(10,5,'Autres Ht :',0,1,'L');
        $this->SetXY(65,181);
        $this->Cell(30,3.5,'',1,1,'C',true);
    }
    function cdroite()
    {
        ...
        $this->SetFont('Arial','B',11);
        $this->SetXY(133,140);
        $this->Cell(35,5,'Oscillot (vue int)',0,1,'C',true);
        $this->SetFont('Arial','',8);
        //ouvrant gauche
        $this->SetXY(120,147);
...
$pdf->cgauche();
$pdf->Image('Oscillot.png',52,112,15,0);
$pdf->cdroite();
