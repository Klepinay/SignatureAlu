...
class PDF extends FPDF
{
    ...
    function ec(/*$reep,$qtee,$lge,$hte*/)
    {
        ...
        $this->SetXY(82,29);
        $this->Cell(40,10,'Chassis a Projection',0,1,'C');
    ...
    function cdroite()
    {
        ...
        //ouvrant gauche
        $this->SetXY(120,147);
        $this->Cell(10,5,'Poignee Pivotante',0,1,'L');
        $this->SetXY(115,147);
        $this->Cell(5,3.5,'',1,1,'C');
        //Compa
        $this->SetXY(120,153);
        $this->Cell(10,5,'COMPAS DE MARCOS',0,1,'L');
        $this->SetXY(115,153);
        $this->Cell(5,3.5,'',1,1,'C');
        //Projection
        $this->SetXY(120,159);
        $this->Cell(10,5,'Projection a Verin',0,1,'L');
        $this->SetXY(115,159);
        $this->Cell(5,3.5,'',1,1,'C');
        //ouvrant droit
        $this->SetXY(160,147);
        $this->Cell(10,5,'Poignee de tirage',0,1,'L');
        $this->SetXY(155,147);
        $this->Cell(5,3.5,'',1,1,'C');
        //moteur souff
        $this->SetXY(160,153);
...
$pdf->cgauche();
$pdf->Image('Projetant.png',52,112,15,0);
$pdf->cdroite();
